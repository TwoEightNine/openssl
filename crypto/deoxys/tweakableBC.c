...
int deoxysKeySetupEnc256(uint32_t *rtweakey,
    ...
    for (r = 0; r <= Nr; r++) {
        ...
        rtweakey[4 * r + 0] =
                GETU32(tweakey[0] + 0) ^ GETU32(tweakey[1] + 0) ^ ((3 == no_tweakeys) * GETU32(tweakey[2] + 0)) ^
                rcon_row1;
        rtweakey[4 * r + 1] =
                GETU32(tweakey[0] + 4) ^ GETU32(tweakey[1] + 4) ^ ((3 == no_tweakeys) * GETU32(tweakey[2] + 4)) ^
                GETRCON(r);
        rtweakey[4 * r + 2] =
                GETU32(tweakey[0] + 8) ^ GETU32(tweakey[1] + 8) ^ ((3 == no_tweakeys) * GETU32(tweakey[2] + 8));
        rtweakey[4 * r + 3] =
                GETU32(tweakey[0] + 12) ^ GETU32(tweakey[1] + 12) ^ ((3 == no_tweakeys) * GETU32(tweakey[2] + 12));
...
int deoxysKeySetupDec256(uint32_t *rtweakey,
    ...
    for (i = 0, j = 4 * Nr; i < j; i += 4, j -= 4) {
        ...
        rtweakey[j] = temp;
        temp = rtweakey[i + 1];
        rtweakey[i + 1] = rtweakey[j + 1];
        rtweakey[j + 1] = temp;
        temp = rtweakey[i + 2];
        rtweakey[i + 2] = rtweakey[j + 2];
        rtweakey[j + 2] = temp;
        temp = rtweakey[i + 3];
        rtweakey[i + 3] = rtweakey[j + 3];
        rtweakey[j + 3] = temp;
    }
...
void aesTweakEncrypt(uint32_t tweakey_size,
    ...
    Nr = deoxysKeySetupEnc256(rk, key, tweakey_size / 16);
...
void aesTweakDecrypt(uint32_t tweakey_size,
    ...
    /* Produce the round tweakeys */
    Nr = deoxysKeySetupDec256(rk, key, tweakey_size / 16);
